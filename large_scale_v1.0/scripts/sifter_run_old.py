    ...
    def thread_operation(self, thread_data):
        ...
        try:
            ...
            if os.path.exists(evidence_file+'.gz'):
                ...
                subprocess.check_call("gunzip -c %s.gz > %s.%d"%(evidence_file,evidence_file,rand_id_2),shell=True)
            ...
            #go_ontology_sqlite = '/data/mohammad/sqlite_goterm_db/goterms_20130927.sqlite'
