...
class ProcessingThread(threading.Thread):
    ...
    def thread_operation(self, thread_data):
        ...
        try:
            ...
            if os.path.exists('/scratch/mohammad/sqlite_goterm_db'):
                go_ontology_sqlite = '/scratch/mohammad/sqlite_goterm_db/goterms_20150331.sqlite'
            else:
                go_ontology_sqlite = '/data/mohammad/sqlite_goterm_db/goterms_20150331.sqlite'



            java_sifter_cmd = \
                "java -jar -Xmx32g " + sifter_java + " " +\
                "--generate " + " " +\
                evidence_str + " " +\
